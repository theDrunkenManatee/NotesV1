...
public class NewFolderDialog extends AppCompatDialogFragment {
    ...
    private newFolderDialogListener listener;
        ...
        builder.setView(view)
                ...
                .setPositiveButton("ok", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogeInterface, int i) {
                        ...
                        listener.applyNewFolderText(inText);
                    }
    ...
    public void onAttach(Context context) {
        ...
        try{
            listener = (newFolderDialogListener) context;
    ...
    public interface newFolderDialogListener {
        void applyNewFolderText(String newName);
    }
}
